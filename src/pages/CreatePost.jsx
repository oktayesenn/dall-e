  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch('http:http://localhost:8080/api/v1/post', {
          method: 'POST',
          headers: {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">Generate an imaginative image through ESEN-TECH AI and share it with the community</p>
      </div>
